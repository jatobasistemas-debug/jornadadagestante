...
export function PatientShell({clinic,current,children}:{clinic:Clinic;current:'gestante'|'gestante/jornada'|'gestante/memorias'|'gestante/clinica'|'conta';children:React.ReactNode}){
